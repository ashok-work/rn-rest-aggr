...
const defaultAddress = [{ id: '1', label: 'Home', fullAddress: '123 Food Street, Delicious City, 90210', phone: '+1 234 567 890', isDefault: true }];

const initialState: AddressState = {
  addresses: savedAddresses ? JSON.parse(savedAddresses) : defaultAddress,
};
